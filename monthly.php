...
function Header()
{
    ...
    $this->Cell(10,10,'Monthty Report');
    $this->Ln();
    $this->Cell(1);
    $this->SetFont('Arial','i',10);
    $this->Cell(10,10,'Date Form: '.$_GET["datefrom"].'                     Date To: '.$_GET["dateto"]);
    $this->Ln(10);
    $this->Cell(15);
...
$pdf->SetFont('Times','',12);
         $listClient = mysql_query("select c.id as id,
                                          ...
                                          where b.billDate between '".$_GET["datefrom"]."' and '".$_GET["dateto"]."' and c.meter_num=b.client_id order by bill_Id ASC");
$total=0;
