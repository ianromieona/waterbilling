...
function Header()
{
    ...
    $this->Cell(10,10,'Due Date Report');
    $this->Ln();
    $this->Cell(1);
    $this->SetFont('Arial','i',10);
    ...
    $this->Cell(10,10,'OR NO                 Meter NO                  Client                 Bill ID                Due Date                 Bill Amount');
    // Line break
    $this->Ln(20);
}
...
$pdf->SetFont('Times','',12);
         $listClient = mysql_query("select c.id as id,
                                          ...
                                          where b.dueDate>='".date("Y-m-d")."' and c.meter_num=b.client_id order by bill_Id ASC");
$total=0;
